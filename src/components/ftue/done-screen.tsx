      ...
      >
        ...
        <div className="flex flex-col items-center gap-5">
          <button
            type="button"
            onClick={onRestart}
            className="flex items-center gap-1 rounded-[2px] bg-primary px-3 pb-[7px] pt-[9px] text-[14px] font-semibold leading-4 text-primary-foreground transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
          >
            OPEN MY INBOX NOW
            <Sparkle />
          </button>
