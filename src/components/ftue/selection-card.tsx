...
function GradientBadge({ children }: { children: React.ReactNode }) {
  return (
    <span
      className="inline-block shrink-0 rounded-[2px] px-1.5 py-[5px] text-[10.67px] font-semibold leading-none text-black/75 [text-box-edge:cap_alphabetic] [text-box-trim:trim-both]"
      style={{
        backgroundImage:
