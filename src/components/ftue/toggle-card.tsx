...
export function ToggleCard({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex -ml-5 w-[calc(100%_+_20px)] items-center gap-2.5 rounded-[6px] border-[0.5px] border-[rgba(236,236,236,0.3)] px-5 py-3.5 transition-all duration-300 hover:z-10",
        highlighted
